...
def recommendations():
    if request.method == 'POST':
        ...
        if content_based_rec.empty:
            ...
            # Create random image URLs and prices
            random_product_image_urls = [f"https://example.com/image{idx}.jpg" for idx in range(len(content_based_rec))]
            prices = [40, 50, 60, 70, 100, 122, 106, 50, 30, 50]
            random_prices = [random.choice(prices) for _ in range(len(content_based_rec))]
